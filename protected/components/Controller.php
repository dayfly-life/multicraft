...
/*]]>*/
    ...
    function listLanguages()
    {
        ...
        {
            if (in_array($lang, array('.', '..', 'en', 'empty', 'ko')))
                continue;
            $li = @include($msgDir.$lang.'/name.php');
            if ($li)
                $langInfo[$lang] = $li;
            else if (is_dir($msgDir.$lang))
                $langInfo[$lang] = array('short'=>$lang, 'english'=>$lang, 'local'=>$lang, 'ko' => $lang);
        }
    ...
    function languageSelection()
    {
        ...
        natcasesort($sel);
        return array(''=>Yii::t('mc', 'Default'), 'en'=>'English', 'ko'=>'Korean') + $sel;
    }
